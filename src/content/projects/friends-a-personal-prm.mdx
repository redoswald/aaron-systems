---
title: Friends (a personal PRM)
description: A spreadsheet-turned-app that tells me which friends I'm overdue to see.
date: 2025-12-01
draft: false
status: in-progress
link: https://friends.aaronos.ai
repo: https://github.com/redoswald/all_friends
featured: true
---
# From Spreadsheet Social Tracking to a Friends App
...
… but if you’re willing to use an app… well...

As soon as Claude Code came out, I started experimenting with it. The result is Friends—a web app.
...
![Friends app screenshot](/projects/friends-screenshot.png)

...
Most [dystopian novels](https://amzn.to/2CJZpvW) are about the relationship between power, knowledge, and meaning. 1984 and Brave New World are the two heavyweights in this area. In 1984, restricted knowledge gives the Party power and they have the ability to rewrite truth and control individual's ability to perceive meaning. Brave New World describes a world where meaning is annihilated by what we would now understand as unrestricted access to dopamine, and where power is no longer held by any individual: The System controls the world.

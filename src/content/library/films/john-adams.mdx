...
director: "Tom Hooper"
year: 2008
# TV miniseries — id 15114 is in TMDB's TV namespace, but the site queries the
# movie endpoint (where 15114 is a different film), so use a manual cover instead
cover: "https://image.tmdb.org/t/p/w500/34qRIcLKkTpmM9x9gzm9nKvo5pW.jpg"
